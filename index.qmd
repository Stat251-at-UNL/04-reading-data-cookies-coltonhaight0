...
import pandas as pd
cookiespy2 = (
  cookiespy.groupby(['Ingredient','Quantity','Unit'])['Unit'].count()
...
rcookiesleast <- cookies |> count(Ingredient, Quantity, Unit) |>
  arrange(desc(n))
...
cookiesleast20 = (cookiespyleast2[cookiespyleast2['n'] < 20])
