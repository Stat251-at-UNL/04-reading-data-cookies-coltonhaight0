...
rcookiesproportion <- cookies |>
  ...
  group_by(Ingredient) |>
  summarise(number_recipies = n())|>
  mutate(recipe_prop = number_recipies/209) |>
...
rcookiesleast <- rcookiesproportion |> count(Ingredient, number_recipies) |>
  arrange(desc(number_recipies))

rcookiesleast20 <- rcookiesleast |>
  filter(number_recipies < 20)
